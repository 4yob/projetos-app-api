  ...
  try {
    ...
    const drawHeader = () => {
      ...
      doc
        ...
        .text("Usuário", 90, headerY + textYOffset, {
          width: 100,
          align: "left",
        })
        .text("Conteúdo", 200, headerY + textYOffset, {
          width: 180,
          align: "left",
        })
        .text("Likes", 390, headerY + textYOffset, {
          width: 50,
          align: "right",
        })
        .text("Data", 460, headerY + textYOffset, {
          width: 90,
          align: "right",
        });
    ...
    if (posts.length > 0) {
      ...
      posts.forEach((post, i) => {
        ...
        doc
          ...
          .font("Helvetica")
          .fontSize(fontSize)
          .text(post.id || "", 52, currentY + textYOffset, {
            width: 30,
            align: "left",
            lineBreak: false,
          })
          .text(
            (post.user_name || "").slice(0, 20),
            90,
            currentY + textYOffset,
            { width: 100, align: "left", lineBreak: false }
          )
          .text(
            (post.content || "").slice(0, 45),
            200,
            currentY + textYOffset,
            { width: 180, align: "left", lineBreak: false }
          )
          .text(String(post.likes ?? 0), 390, currentY + textYOffset, {
            width: 50,
            align: "right",
            lineBreak: false,
          })
  ...
  try {
    ...
    const drawHeader = () => {
      ...
      doc
        ...
        .text("Username", 200, headerY + textYOffset, {
          width: 90,
          align: "left",
        })
        .text("Seguidores", 300, headerY + textYOffset, {
          width: 60,
          align: "right",
        })
        .text("Seguindo", 370, headerY + textYOffset, {
          width: 60,
          align: "right",
        })
        .text("Localização", 440, headerY + textYOffset, {
          width: 90,
          align: "right",
        });
    ...
    if (users.length > 0) {
      ...
      users.forEach((user, i) => {
        ...
        doc
          ...
          .font("Helvetica")
          .fontSize(fontSize)
          .text(user.id || "", 52, currentY + textYOffset, {
            width: 30,
            align: "left",
            lineBreak: false,
          })
          .text((user.name || "").slice(0, 20), 90, currentY + textYOffset, {
            width: 100,
            align: "left",
            lineBreak: false,
          })
          .text(
            ...
            200,
            currentY + textYOffset,
            { width: 90, align: "left", lineBreak: false }
          )
          .text(String(user.followers ?? 0), 300, currentY + textYOffset, {
            width: 60,
            align: "right",
            lineBreak: false,
          })
          .text(String(user.following ?? 0), 370, currentY + textYOffset, {
            width: 60,
            align: "right",
            lineBreak: false,
          })
    ...
    if (notifications.length > 0) {
      ...
      notifications.forEach((notif, i) => {
        ...
        doc
          ...
          .font("Helvetica")
          .fontSize(fontSize)
          .text(notif.id || "", 52, currentY + textYOffset, {
            width: 30,
            align: "left",
            lineBreak: false,
          })
          .text(String(notif.user_id || ""), 90, currentY + textYOffset, {
            width: 60,
            align: "left",
            lineBreak: false,
          })
          ...
          .text(
            notif.post_id !== null ? String(notif.post_id) : "-",
            330,
            currentY + textYOffset,
            { width: 50, align: "right", lineBreak: false }
          )
          .text(
            notif.chat_id !== null ? String(notif.chat_id) : "-",
            390,
            currentY + textYOffset,
            { width: 50, align: "right", lineBreak: false }
          )
  ...
  try {
    ...
    const drawHeader = () => {
      ...
      doc
        ...
        .text("Comentário", 190, headerY + textYOffset, {
          width: 220,
          align: "left",
        })
        .text("Post ID", 420, headerY + textYOffset, {
          width: 50,
          align: "right",
        })
        .text("Data", 470, headerY + textYOffset, {
          width: 80,
          align: "right",
        });
    ...
    if (comments.length > 0) {
      ...
      comments.forEach((comment, i) => {
        ...
        doc
          ...
          .font("Helvetica")
          .fontSize(fontSize)
          .text(comment.id || "", 52, currentY + textYOffset, {
            width: 30,
            align: "left",
            lineBreak: false,
          })
          .text(
            (comment.user_name || "").slice(0, 20),
            90,
            currentY + textYOffset,
            { width: 90, align: "left", lineBreak: false }
          )
          .text(
            (comment.text_comment || "").slice(0, 60),
            190,
            currentY + textYOffset,
            { width: 220, align: "left", lineBreak: false }
          )
          .text(String(comment.post_id || ""), 420, currentY + textYOffset, {
            width: 50,
            align: "right",
            lineBreak: false,
          })
  ...
  try {
    ...
    const drawHeader = () => {
      ...
      doc
        ...
        .text("Mensagem", 200, headerY + textYOffset, {
          width: 200,
          align: "left",
        })
        .text("Data", 410, headerY + textYOffset, {
          width: 90,
          align: "right",
        });
    ...
    if (chats.length > 0) {
      ...
      chats.forEach((chat, i) => {
        ...
        doc
          ...
          .font("Helvetica")
          .fontSize(fontSize)
          .text(chat.id || "", 52, currentY + textYOffset, {
            width: 30,
            align: "left",
            lineBreak: false,
          })
          .text(
            (chat.user_name || "").slice(0, 20),
            90,
            currentY + textYOffset,
            { width: 100, align: "left", lineBreak: false }
          )
...
const exportCategoriasPDF = async (req, res) => {
  try {
    const categorias = await categoriaModel.getCategorias();

    res.setHeader("Content-Type", "application/pdf");
    res.setHeader("Content-Disposition", "inline; filename=categorias.pdf");
    ...
    const drawCoverPage = () => {
      ...
      doc
        ...
        .fontSize(22)
        .fillColor("#6b2e2e")
        .text("Glamsync Categorias", textStartX, textY);
    ...
    const drawHeader = () => {
      ...
      doc
        ...
        .fontSize(fontSize)
        .fillColor("white")
        .text("ID", 52, headerY + textYOffset, { width: 80, align: "left" })
        .text("Nome da Categoria", 140, headerY + textYOffset, {
          width: 300,
          align: "left",
        });
    ...
    if (categorias.length > 0) {
      ...
      categorias.forEach((categoria, i) => {
        ...
        doc
          ...
          .font("Helvetica")
          .fontSize(fontSize)
          .text(categoria.id || "", 52, currentY + textYOffset, {
            width: 80,
            align: "left",
            lineBreak: false,
          })
          .text(
            (categoria.name || "").slice(0, 60),
            140,
            currentY + textYOffset,
